...
export const ADMIN_PERMISSION_RESOURCES = [
  ...
  createPermissionResource("top_college_section", "Top Colleges Section"),
  ...
  createPermissionResource("mock_test_results", "Mock Test Results", ["view", "add", "edit"]),
...
export const ADMIN_RESOURCE_ACCESS = {
  ...
  TopCollegeSection: {
    permissionResource: "top_college_section",
  },
  MockTestCourse: {
  ...
  MockTestResult: {
    permissionResource: "mock_test_results",
  },
  QuestionBank: {
